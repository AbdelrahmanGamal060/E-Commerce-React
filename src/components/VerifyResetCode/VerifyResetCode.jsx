...
export default function ForgetYourPassword() {
  ...
  return <>
    <form onSubmit={VerifyResetCodeform.handleSubmit}>
      <div className="mb-5">
        <label htmlFor="resetCode" className="block mb-2 text-sm font-medium text-gray-900 :text-white">reset your account password</label>
        <input
          name='resetCode'
          ...
          type="text" id="resetCode" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 :border-blue-500 block w-full p-2.5 =:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="your Code" required />
