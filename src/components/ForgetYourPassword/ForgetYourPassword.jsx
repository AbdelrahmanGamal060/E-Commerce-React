import Style from "./ForgetYourPassword.module.css"
    ...
    <form onSubmit={forgetPasswordForm.handleSubmit}>
      <div className="mb-5">
        ...
        <input
          ...
          type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 :border-blue-500 block w-full p-2.5 =:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Email" required />
